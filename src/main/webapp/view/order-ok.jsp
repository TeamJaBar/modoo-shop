				...
				<div class="content_box">
					<div class="member_wrap order_agreement_wrap">
						<div class="member_tit">
							<!-- <h2>장바구니</h2> -->
							<ol>
								<li><span>01</span> 장바구니 <span> <img src="/ModooShop/images/icons/icon_join_step_off.png">
									</span></li>
								<li><span>02</span> 주문서 작성/결제 <span> <img src="/ModooShop/images/icons/icon_join_step_off.png">
									</span></li>
						...
						<div class="member_cont" id="order_ok_member_content">
							<div class="order_ok_box">
								...
								<div class="btn_member_sec">
									<ul>
										<li><button id="btnHome">
												<a href="main.html">계속 쇼핑하기</a>
											</button></li>
										<li><button class="btn_login">
												<a href="login.html" style="color: #fff">홈으로</a>
											</button></li>
									</ul>
								</div>
								<!-- //btn_member_sec -->
