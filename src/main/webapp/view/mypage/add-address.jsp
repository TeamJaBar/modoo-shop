						...
						<div class="scroll_box">
								...
								<table>
									...
									<tbody>
											...
											<td class="member_address">
												<div class="address_postcode">
													<input type="text" name="shippingZonecode" value=""
														required> <input type="button" id="find_address"
														class="m-t-5" onclick="sample3_execDaumPostcode()"
														value="우편번호 찾기" required> <input type="hidden"
														name="shippingZipcode" value="">
										...
										<tr>
											...
											<td><input type="text" id="shippingPhone"
												name="shippingPhone" value=""></td>
										</tr>
										<tr>
											<th scope="row"><span class="important">휴대폰번호</span></th>
											<td><input type="text" id="shippingMobile"
												name="shippingCellPhone" value="" required></td>
										</tr>
									</tbody>
								</table>
							</div>
							...
							<div class="form_element" style="display: flex">
								<input type="checkbox" id="defaultFl" name="defaultFl" value="y"
									class="checkbox"> <label for="defaultFl"
									style="margin-left: 10px; margin-bottom: 15px; font-family: GmarketSansLight"
									class="check_s"><b>기본 배송지로 설정 합니다.</b></label>
							</div>
						</div>
...
<script>
	...
	$('#shippingPhone').focusout(
			function() {
				...
				if (!phoneCheckFst.test(fst) || !phoneCheckSnd.test(snd)
						|| !phoneCheckTrd.test(trd)) {
