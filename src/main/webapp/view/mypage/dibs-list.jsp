   ...
   <section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/bg-02.jpg');">
	...
	<div class="container">
		<div class="bread-crumb flex-w p-l-1 p-r-15 p-t-30 p-lr-0-lg">
			...
			</span> <span class="stext-109 cl4"> 찜리스트 </span>
		</div>
	</div>
													...
													<table style="text-align: center;">
														...
														<tbody>
															...
															<tr class="table_row start">
																<td class="column-0"><input type="checkbox"
																	id="check" name="check"></td>
																<td class="column-1" style="text-align: start;">20230105</td>
																<td class="column-2" style="text-align: start;">모두의
																	마블</td>
																<td class="column-3" style="text-align: start;">2 개</td>
																<td class="column-4" style="text-align: start;">52500원</td>
																<td class="column-5" style="text-align: start;">105000원</td>
															</tr>
														</tbody>
													</table>
												</div>
