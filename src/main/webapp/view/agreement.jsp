				...
				<div class="join_agreement_wrap">
					...
					<div class="member_cont">
						<form id="formTerms" name="formTerms">
							<div class="join_agreement_cont">
								...
								<div class="join_agreement_box js_terms_view">
									...
									<div class="agreement_box">
										1. - 목적 : 이용자 식별 및 본인여부 확인<br> - 항목 : 이름, 아이디, 비밀번호<br> - 보유 및 이용기간 : 회원탈퇴 후 5일까지<br> <br> 2. - 목적 : 민원 등 고객 고충처리<br> - 항목 : 이메일, 휴대전화번호<br> - 보유 및 이용기간 : 회원탈퇴 후 5일까지<br> <br> 3. - 목적 : 만 14세 미만 아동 확인<br> - 항목 : 법정 생년월일<br> - 보유 및 이용기간 : 회원탈퇴 후 5일까지
									</div>
									<!-- //agreement_box -->
								</div>
								<!-- //join_agreement_box -->
						...
						<!-- <div class="important_check_box">
										<strong class="important_check">(필수) 이용약관을 체크해주세요.</strong>
								</div> -->
						<div class="btn_center_box">
							<button onclick="history.go(-1);" id="btnPrevStep" class="btn_member_prev hov-btn3">이전단계</button>
							<button id="btnNextStep" class="btn_member_next hov-btn3">다음단계</button>
						</div>
						<!-- //btn_center_box -->
					</div>
					<!-- //member_cont -->
