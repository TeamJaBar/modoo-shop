							...
							<div class="hack_out">
								...
								<div class="mypage_unregister">
									<div class="unregister_info" style="font-size: 10px;">
										보드게임몰 이용안내 <br> <br> ■ 회원가입안내<br> ① 저희 보드게임몰은
										...
										저희보드게임몰은 마일리지를 사용할 수 있습니다.<br> ② 마일리지 100점은 현금 100원과
										같습니다.<br> ③ 마일리지는 1,000,000원 이 넘는 금액의 적립금은 사용하실 수가 없습니다.<br>
										<br> <br> ■ 상품주문방법<br> 저희보드게임몰에서 상품을 주문하는 방법은
										...
										배송조회시스템<br> 보드게임몰에서 주문을 하셨을 경우 주문/배송 확인을 통해서 실제 주문이 어떻게
										...
										■ 안전한 대금 결제 시스템<br> 저희 보드게임몰은 무통장 입금과 신용카드의 두 가지 결제방법을
										...
										저희 보드게임몰에서는 구입하신 상품의 배송 방법을 CJ대한통운택배 서비스를 원칙으로 하고 있습니다. (배송방법은
										상품 종류에 따라 상이할 수 있습니다.)<br> <br> <br> ■ 주문취소, 교환
										및 환불<br> 보드게임몰은 소비자의보호를 위해서 규정한 제반 법규를 준수합니다.<br> 주문
