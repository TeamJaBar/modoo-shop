				...
				<div class="content_box">
					<div class="member_wrap join_agreement_wrap">
						<div class="member_tit">
							<!-- <h2>회원가입</h2> -->
							<ol>
								<li><span>01</span> 약관동의 <span> <img src="../../images/icons/icon_join_step_off.png">
									</span></li>
								<li><span>02</span> 정보입력 <span> <img src="../../images/icons/icon_join_step_off.png">
									</span></li>
						...
						<div class="member_cont" id="join_ok_member_content">
							<div class="join_ok_box">
								<div class="join_ok_tit">
									...
									<p>
										<span>이성훈</span>님의 회원가입을 축하합니다. <br> 알차고 실속있는 서비스로
										찾아뵙겠습니다.
									</p>
								</div>
								<!-- //join_ok_tit -->
								<div class="btn_member_sec">
									<ul>
										...
										<li><button class="btn_login">
												<a href="login.html" style="color: #fff">로그인</a>
											</button></li>
									</ul>
								</div>
								<!-- //btn_member_sec -->
