						...
						<div class="member_cont" id="join_ok_member_content">
							<div class="join_ok_box">
								...
								<div class="btn_member_sec">
									<ul>
										<li>
											<button onclick="location.href='/ModooShop/view/main.jsp'" id="btnHome" class="btnHome hov-btn3">
											홈으로
											</button></li>
										<li>
											<button onclick="location.href='login.jsp'" id="btn_login" class="btn_login hov-btn3">
											로그인
											</button></li>
									</ul>
								</div>
