                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>전략</td>
                                        <td>P0000001</td>
                                        <td><img class="adminImg" src="/ModooShop/images/p001.jpg" alt="샘플1 루미큐브">루미큐브</td>
                                        <td>5,000</td>
                                        <td>5,000</td>
                                        <td><a class="btn btn-primary" href="admin-product-update.jsp">상품 변경</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>파티게임</td>
                                        <td>P0000002</td>
                                        <td><img class="adminImg" src="/ModooShop/images/p002.jpg" alt="샘플2 악어새">악어새</td>
                                        <td>10,000</td>
                                        <td>10,000</td>
                                        <td><a class="btn btn-primary" href="admin-product-update.jsp">상품 변경</a>
                                            <a class="btn btn-danger" href="#" onClick="del()">상품 삭제</a>
