...
public class ProductDAO {
	...
	final String SELECTALL_AGE = "SELECT DIB, PNUM, CATENUM, PNAME, FIXPRICE, SELPRICE, RDATE, REPERSON, REAGE, BRAND, PIMG, "
			+ "CASE WHEN REAGE BETWEEN 0 AND 3 THEN 1 WHEN REAGE BETWEEN 4 AND 6 THEN 2 WHEN REAGE BETWEEN 7 AND 10 THEN 3 WHEN REAGE BETWEEN 11 AND 13 THEN 4 END AS CATEAGE "
